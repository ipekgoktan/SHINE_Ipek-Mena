...
struct ImageClustering_
{
  ...
  _header_type header;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _cluster_type;
...
struct Printer< ::vision_msgs::ImageClustering_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::vision_msgs::ImageClustering_<ContainerAllocator>& v)
  {
    ...
    s << indent << "cluster: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.cluster);
